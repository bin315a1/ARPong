...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    /// </summary>
    public class OurCloudAnchorUIController : MonoBehaviour
    {
        /// <summary>
        /// The Cloud Controller
        /// </summary>
        public OurCloudController CloudController;
        ...
        /// <summary>
        /// The Scoreboard for players 1 and 2.
        /// </summary>
        public GameObject ScoreBoard;

        /// <summary>
        /// The Button to start/stop the game
        /// </summary>
        ...
        public void ShowHostingModeBegin(string snackbarText = null)
        {
            ...
            else // if Hosting succeeded with Anchor placed
            {
        ...
        /// <summary>
        /// Toggles UI between showing start or stop
        /// </summary>
        /// <param name="playText">Play text.</param>
        public void ShowPlayingMode(string playText = "Good")
        {
            if (playText == "Good")
            {
                PlayerButtons.SetActive(true);
                ScoreBoard.SetActive(true);
                SnackbarText.text = "Connected!";
                return;
            }

            StartStopButton.GetComponentInChildren<Text>().text = playText;
            if (playText == "Disconnect")
            {
                string temp = "client";
                if (CloudController.GetCurrentMode() == OurCloudController.ApplicationMode.Hosting)
                {
                    temp = "host";
                }
                SnackbarText.text = "Connecting to game server as " + temp + "...";
            }
            else
            {
                PlayerButtons.SetActive(false);
                SnackbarText.text = "Stopped.";
            }
        }
