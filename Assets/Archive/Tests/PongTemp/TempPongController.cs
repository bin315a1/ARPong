...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    /// </summary>
    public class TempPongController : MonoBehaviour
    {
        /// <summary>
        ...
        public void Update()
        {
            ...
            if (m_LastPlacedAnchor != null)
            {
                ...
                GameField.transform.SetParent(m_LastPlacedAnchor.transform, false);
            }
        }
        ...
        public void OnNetConnectClick()
        {
            ...
            if (m_CurrentMode == ApplicationMode.Resolving)
            {
                ...
                NetClicked = true;
                NetController.networkAddress = "localhost";
                //NetController.networkAddress = UIController.GetIpAddressInputValue();
        ...
        /* changed implementation of the ButtonAction() ButtonStop() functions! */
        /*
        /// <summary>
        ...
        public void OnLeftButtonDown()
        {
            ...
            foreach (GameObject playerObject in playerObjects)
            {
                ...
                if (m_CurrentMode == ApplicationMode.Hosting)
                    playerPaddleObject.ButtonLeftAction();
                else if (m_CurrentMode == ApplicationMode.Resolving)
                    playerPaddleObject.ButtonRightAction();
            }
        }
        ...
        public void OnLeftButtonUp()
        {
            ...
            foreach (GameObject playerObject in playerObjects)
            {
                PlayerPaddleControl playerPaddleObject = playerObject.GetComponent<PlayerPaddleControl>();
                if (m_CurrentMode == ApplicationMode.Hosting)
                    playerPaddleObject.ButtonLeftStop();
                else if (m_CurrentMode == ApplicationMode.Resolving)
                    playerPaddleObject.ButtonRightStop();
            }
        }
        ...
        */
        ...
        private void _ResolveAnchorFromId(string cloudAnchorId)
        {
            XPSession.ResolveCloudAnchor(cloudAnchorId).ThenAction((System.Action<CloudAnchorResult>)(result =>
            {
                ...
                Instantiate(_GetGameFieldPrefab(), result.Anchor.transform);
                GameField.SetActive(true);
                GameField.transform.SetParent(m_LastResolvedAnchor.transform, false);
