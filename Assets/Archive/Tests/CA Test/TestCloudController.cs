...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    /// </summary>
    public class TestCloudController : MonoBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        public TempUIController UIController;

        public OurCloudNetworkManager NetController;
        ...
        {
            GameObject[] playerObjects = null;

            if (playerObjects == null)
            {
                //gameManager = GameObject.FindWithTag("GameManager").GetComponent(typeof(GameManager)) as GameManager;
                playerObjects = GameObject.FindGameObjectsWithTag("Player");
                //players = GameObject.Find
            }

            foreach (GameObject playerObject in playerObjects)
            {
                CloudControllerPlayer Cntrol = playerObject.GetComponent<CloudControllerPlayer>();
                Cntrol.ButtonLeftAction();
            }
        }
        ...
        private void _LostConnection()
        {
            if (m_CurrentMode == ApplicationMode.Hosting)
            {
                // If you're hosting, the server continues
                return;
            }
